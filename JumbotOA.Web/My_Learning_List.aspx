<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="My_Learning_List.aspx.cs"
    Inherits="JumbotOA.Web.My_Learning_List" %>
                                                ...
                                                <asp:Repeater ID="Sinfo_repeater" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <a href="javascript:void(0);" onclick="top.OA.Popup.show('My_Learning_Show.aspx?id=<%#Eval("Sid") %>',-1,-1,true)"><%#Eval("Stitle")%></a>
                                                            </td>
                                                            <td align="center">
                                                                <%#Eval("Sdate")%>
                                                            </td>
                                                            <td align="center">
                                                                <a href="javascript:void(0);" onclick="top.OA.Popup.show('My_Learning_Show.aspx?id=<%#Eval("Sid") %>',-1,-1,true)">查看</a>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
