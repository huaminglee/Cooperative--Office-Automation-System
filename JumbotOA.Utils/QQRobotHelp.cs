...
namespace JumbotOA.Utils
{
    ...
    /// QQ机器人操作类
    /// </summary>
    public static class QQRobotHelp
    {
        public static string AdminQQ = XmlCOM.ReadConfig("~/_data/config/qqrobot", "AdminQQ");
        public static string QunQQ = XmlCOM.ReadConfig("~/_data/config/qqrobot", "QunQQ");
        public static string ApiServer = XmlCOM.ReadConfig("~/_data/config/qqrobot", "ApiServer");//机器人地址
        public static string ApiPort = XmlCOM.ReadConfig("~/_data/config/qqrobot", "ApiPort");//API端口
        public static string Copyright = XmlCOM.ReadConfig("~/_data/config/qqrobot", "Copyright");//密钥
