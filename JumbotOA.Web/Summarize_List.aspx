<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summarize_List.aspx.cs"
    Inherits="JumbotOA.Web.Summarize_List" %>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td height="25" valign="top" style="padding-top: 2px; padding-left: 6px; padding-right: 6px;
                                                padding-bottom: 2px;">
                                                <asp:Repeater ID="Repeater_Summarize" runat="server">
                                                    <HeaderTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <span title="<%#Eval("Sutitle")%>">
                                                                    <%#Eval("Sutitle")%></span>
                                                            </td>
                                                            <td align="center">
                                                                <a href="javascript:void(0);" onclick="OA.Popup.show('Summarize_Show.aspx?id=<%#Eval("Suid") %>',-1,-1,true)">
                                                                    查看</a>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
