<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="My_Task_List.aspx.cs" Inherits="JumbotOA.Web.My_Task_List" %>
                                                ...
                                                <asp:Repeater ID="Repeater_Work" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td  align="center">
                                                            <%# JumbotOA.Utils.Strings.Left(Eval("remark").ToString(),20)%>
                                                            </td>
                                                            <td >
