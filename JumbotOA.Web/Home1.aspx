<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home1.aspx.cs" Inherits="JumbotOA.Web.Home1" %>
...
<body onload="javascript:border_left('left_tab8','left_menu_cnt8');">
        ...
        <thead>
            ...
            <th>
              ...
              <div style="float:left;margin-top:5px;">
                  <asp:Label ID="oktime" runat="server" Font-Bold="False" ForeColor="Black"></asp:Label>  <%--<script language="JavaScript" type="text/javascript">
function Year_Month(){ 
    var now = new Date(); 
    var yy = now.getYear(); 
    var mm = now.getMonth()+1; 
    var cl = '<font color="#080808">'; 
    if (now.getDay() == 0) cl = '<font color="#080808">'; 
    if (now.getDay() == 6) cl = '<font color="#080808">'; 
    return(cl +  yy + '年' + mm + '月</font>'); }
 function Date_of_Today(){ 
    var now = new Date(); 
    var cl = '<font color="#ffoooo">'; 
    if (now.getDay() == 0) cl = '<font color="#080808">'; 
    if (now.getDay() == 6) cl = '<font color="#080808">'; 
...
document.all.calendarClock4.innerHTML = CurentTime(); }
 var webUrl = webUrl; 
document.write('<table  width="210" height="25" border="0" cellpadding="0" cellspacing="0" ><tr><td>'); 
document.write('<table id="CalendarClockFreeCode" border="0" cellpadding="0" cellspacing="0" width="210" height="25" bgcolor="#080808"');
document.write('style="position:absolute;visibility:hidden" bgcolor="#080808">');
document.write('<tr><td align="center"><font ');
document.write('style="cursor:hand;color:#FFCCCC;font-family:宋体;font-size:10pt;line-height:110%" ');
if (webUrl != 'netflower'){ 
   document.write('</td></tr><tr><td align="center"><font ');
   document.write('style="cursor:hand;color:#080808;font-family:宋体;font-size:9pt;line-height:105%" ');
} 
document.write('</td></tr></table></td><td>'); 
document.write('<table border="0" cellpadding="0" cellspacing="0" width="210"  height="25">');
document.write('<tr><td valign="top" width="100%" height="100%">');
document.write('<table border="0" cellpadding="1" cellspacing="0" width="210"  height="25">');
document.write('<tr><td align="center" width="100%" height="100%" >');
document.write('<font id="calendarClock1" style="font-family:宋体;font-size:10pt;line-height:100%"> </font>');
document.write('<font id="calendarClock2" style="color:#ff0000;font-family:Arial;font-size:10pt;line-height:100%"> </font>');
document.write('<font id="calendarClock3" style="font-family:宋体;font-size:9pt;line-height:110%"> </font>');
document.write('<font id="calendarClock4" style="color:#080808;font-family:宋体;font-size:10pt;line-height:100%"><b> </b></font>');
        ...
        <tbody>
            ...
            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign="top">
                                                    <div id="left_menu_cnt1" class="left_menu_cnt">
                                                        ...
                                                        <ul id="dleft_tab8">
                                                            <li id="now_user"><a title="人员管理" onclick="show_title('人员管理')" href="User_List.aspx"target="content3"><span>人员管理</span></a></li>
                                                            <li id="now_operatelog"><a title="查看操作日志" onclick="show_title('查看操作日志')" href="Operatelog_List.aspx" target="content3"><span>查看操作日志</span></a></li>
                                                            <li id="now_adminlog"><a title="管理员日志" onclick="show_title('管理员日志')" href="Adminlog_List.aspx" target="content3"><span>管理员日志</span></a></li>
                                                            <li id="now_password"><a title="密码修改" href="Password_Edit.aspx" onclick="show_title('密码修改')" target="content3"><span>密码修改</span></a></li>
                                                          <li id="now_adminlog"><a title="项目类别" href="Item.aspx" onclick="show_title('项目类别')" target="content3"><span>项目类别管理</span></a></li>
                                                 <li id="now_task"><a title="设置考核指标" onclick="show_title('设置考核指标')" href="Scorelist.aspx" target="content3"><span>设置考核指标</span></a></li>
                                                                                                  <li id="now_time"><a title="通讯录" onclick="show_title('公司通讯录')" href="addresslist.aspx" target="content3"><span>公司通讯录</span></a></li>
                ...
                <td class="t2">
                    <div id="cnt">
                        <table cellpadding="0">
                            <tr><td><iframe id="content3" name="content3" src="User_List.aspx" frameborder="0" width="100%"
