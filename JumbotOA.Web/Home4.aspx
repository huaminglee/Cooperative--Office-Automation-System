<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home4.aspx.cs" Inherits="JumbotOA.Web.Home4" %>
...
<body onload="javascript:border_left('left_tab1','left_menu_cnt1');">
    ...
    <table id="IndexTableBody" cellpadding="0">
        <thead>
            <tr>
                <th>
                  <span style="color: #ffffff;">人员：<%=UserName %>（<%=UserPosition %>）</span>
                </th>
               <th> 
               <div style="float:left; width:330px;margin-top:10px; "><marquee width="262px" direction="right" behavior="alternate" scrollamount="2" onmouseover="stop()" onmouseout="start()"><%=email()%></marquee><asp:LinkButton 
                       ID="LinkButton1" runat="server" onclick="LinkButton1_Click">检索新邮件</asp:LinkButton></div>               <div style="float:right; width:410px;">
             <div style="float:left;margin-top:5px;">
                  <asp:Label ID="oktime" runat="server" Font-Bold="False" ForeColor="Black"></asp:Label> 
                   </div>
<div style="float:right; margin-top:5px; width:196px;"> <iframe src="http://m.weather.com.cn/m/pn7/weather.htm " width="195" height="17" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0"  allowtransparency="true"  scrolling="no"></iframe>
</div></div>
                </th>
            </tr>
        </thead>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="width: 32px" valign="top">
                                                    <ul class="tabpage2">
                                                        <li id="left_tab1" title="菜单" onclick="javascript:border_left('left_tab1','left_menu_cnt1');">
                                                            <span>菜单</span></li>
                                                    </ul>
                                                ...
                                                <td align="left" valign="top">
                                                    <div id="left_menu_cnt1" class="left_menu_cnt">
                                                        ...
                                                        <ul id="dleft_tab1">
                                                            <li id="now_desktop"><a title="我的桌面" onclick="show_title('我的桌面')" href="DeskTop4.aspx"
                                                                target="content3"><span>我的桌面</span></a></li>
                                                            <li id="now_time"><a title="个人考勤" onclick="show_title('个人考勤')" href="My_Time_List.aspx"
                                                                target="content3"><span>个人考勤</span></a></li>
                                                            <li id="now_task"><a title="工作任务" href="My_Task_List.aspx" onclick="show_title('工作任务')"
                                                                target="content3"><span>工作任务</span></a></li>
                                                            <li id="now_worklog"><a title="办公日志" href="My_Worklog_List.aspx" onclick="show_title('办公日志')"
                                                                target="content3"><span>办公日志</span></a></li>
                                                            <li id="now_callinfo"><a title="客户来电" href="My_Callinfo_List.aspx" onclick="show_title('客户来电')"
                                                                target="content3"><span>客户来电</span></a></li>
                                                            <li id="now_summarize"><a title="工作总结" href="My_Summarize_List.aspx" onclick="show_title('工作总结')"
                                                                target="content3"><span>工作总结</span></a></li>
                                                            <li id="now_summarize"><a title="在线评分" onclick="show_title('在线评分')" href="Scorelist.aspx"
                                                                target="content3"><span>在线评分</span></a></li>
                                                            <li id="now_summarize"><a title="项目测试汇报" onclick="show_title('项目测试汇报')" href="Squestion.aspx"
                                                                target="content3"><span>项目测试汇报</span></a></li>
                                                            <li id="now_plan"><a title="我的计划" href="My_Plan_List.aspx" onclick="show_title('我的计划')"
                                                                target="content3"><span>我的计划</span></a></li>
                                                            <li id="now_message"><a title="站内短信" onclick="show_title('站内短信')" href="Message_List.aspx"
                                                                target="content3"><span>站内短信</span></a></li>
                                                            <li id="now_learning"><a title="学习资料" href="My_Learning_List.aspx" onclick="show_title('学习资料')"
                                                                target="content3"><span>学习资料</span></a></li>
                                                            <li id="now_placard"><a title="通知公告" href="My_Placard_List.aspx" onclick="show_title('通知公告')"
                                                                target="content3"><span>通知公告</span></a></li>
                                                                 
                                                            <li id="now_password"><a title="密码修改" href="Password_Edit.aspx" onclick="show_title('密码修改')"
                                                            target="content3"><span>密码修改</span></a></li>
                ...
                <td class="t2">
                    <div id="cnt">
                        <table cellpadding="0">
                            <tr>
                                <td>
                                    <iframe id="content3" name="content3" src="<%=innerUrl %>" frameborder="0" width="100%"
                                        height="100%"></iframe>
                                </td>
                            </tr>
                        </table>
