<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="My_Worklog_List.aspx.cs" Inherits="JumbotOA.Web.My_Worklog_List" %>
                ...
                <td class="actions" width="*">
                    <table cellspacing="0" cellpadding="0" border="0" align="right">
                        <tr>
                            ...
                            <td>
                                <a href="My_Worklog_Add.aspx">新增日志</a>
                            </td>
                        </tr>
                    </table>
                </td>
                                                ...
                                                <asp:Repeater ID="Repeater_Worklog" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <a href="javascript:void(0);" onclick="top.OA.Popup.show('My_Worklog_Show.aspx?id=<%# Eval("Id") %>',-1,-1,true)">查看</a>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
