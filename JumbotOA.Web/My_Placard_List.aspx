<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="My_Placard_List.aspx.cs" Inherits="JumbotOA.Web.My_Placard_List" %>
                                                ...
                                                <asp:Repeater ID="Repeater_Placard" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <a href="javascript:void(0);" onclick="top.OA.Popup.show('My_Placard_Show.aspx?id=<%#Eval("Pid") %>',-1,-1,true)"><%#Eval("Ptitle")%></a>
                                                            </td>
                                                            <td align="center">
                                                                <%#Eval("Pdate")%>
                                                            </td>
                                                            <td align="center">
                                                                <a href="javascript:void(0);" onclick="top.OA.Popup.show('My_Placard_Show.aspx?id=<%#Eval("Pid") %>',-1,-1,true)">查看</a>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
