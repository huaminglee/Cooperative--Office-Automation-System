<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Placard_Show.aspx.cs" Inherits="JumbotOA.Web.Placard_Show" %>
    ...
    <table class="UserTableBorder" cellspacing="1" cellpadding="3" width="96%" align="center"
        ...
        <tr>
            <td class="usertablerow2" align="left" style="height: 32px;font-size:14px;" colspan="2">
                <br />
                <b>主题：</b><asp:Label ID="lblTitle" runat="server" Width="229px"></asp:Label>
                <br />
                <br />
                <b>内容：</b><br />
                <div id="text">
