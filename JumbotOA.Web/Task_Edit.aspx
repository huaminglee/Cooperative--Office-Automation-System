<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Task_Edit.aspx.cs" Inherits="JumbotOA.Web.Task_Edit" %>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td height="20" bgcolor="#f6f9fe" style="border-bottom: 1px solid #f3f6fb; border-top: 1px solid #FFFFFF;">
                                            ...
                                            <asp:TextBox ID="txtBegintime" runat="server" Width="150px" Height="24px" CssClass="ipt" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true,maxDate:'#F{$dp.$D(\'txtEndtime\')}'})"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" bgcolor="#f6f9fe" style="border-bottom: 1px solid #f3f6fb; border-top: 1px solid #FFFFFF;">
                                            <span class="bvjto styp">预计完成时间：</span>
                                            <asp:TextBox ID="txtEndtime" runat="server" Width="150px" Height="24px" CssClass="ipt" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true,minDate:'#F{$dp.$D(\'txtBegintime\')}'})"></asp:TextBox>
                                        </td>
                                    </tr>
                                 <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="Repeater1" runat="server" AutoGenerateColumns="False" 
                                                            DataKeyNames="Id" Width="294px" CellPadding="4" ForeColor="#333333" 
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:CommandField HeaderText="删除" ShowDeleteButton="True" 
                                                                    DeleteImageUrl="~/images/X.gif" ButtonType="Image" Visible="False">
